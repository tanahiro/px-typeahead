...
function runBaseTests() {
  px_typeahead_1 = document.getElementById('px_typeahead_1');

  suite('Base Automation Tests for px-typeahead', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-typeahead fixture is created', function() {
      assert.isTrue(document.getElementById('px_typeahead_1') !== null);
    });
